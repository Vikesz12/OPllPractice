...
namespace Model
{
    public class Cube
    {
        ...
        public Cube()
        {
            ...
            //Front face
            _faces[1] = new Face(RubikColor.G);
            _centers[1] = RubikColor.G;
            //Left face
            _faces[2] = new Face(RubikColor.O);
            _centers[2] = RubikColor.O;
            //Right Face
            _faces[3] = new Face(RubikColor.R);
            _centers[3] = RubikColor.R;
            //Back face
        ...
        public void U()
        {
            ...
            var greenSideBytes = _faces[1].RotateSide(0);
            var orangeSideBytes = _faces[2].RotateSide(0, greenSideBytes);
            var blueSideBytes = _faces[4].RotateSide(0, orangeSideBytes);
            var redSideBytes = _faces[3].RotateSide(0, blueSideBytes);
            _faces[1].RotateSide(0, redSideBytes);
        }
        ...
        public void UPrime()
        {
            ...
            var greenSideBytes = _faces[1].RotateSide(0);
            var redSideBytes = _faces[3].RotateSide(0, greenSideBytes);
            var blueSideBytes = _faces[4].RotateSide(0, redSideBytes);
            var orangeSideBytes = _faces[2].RotateSide(0, blueSideBytes);
            _faces[1].RotateSide(0, orangeSideBytes);
        }

        public void R()
        {
            _faces[3].Rotate(Rotation.ONE);
            var greenSideBytes = _faces[1].RotateSide(2);
            ...
            _faces[1].RotateSide(2, yellowSideBytes);
        }
        public void RPrime()
        {
            ...
            _faces[1].RotateSide(2, whiteSideBytes);
        }
        public void L()
        {
            _faces[2].Rotate(Rotation.ONE);
            var greenSideBytes = _faces[1].RotateSide(6);
            ...
            _faces[1].RotateSide(6, whiteSideBytes);
        ...
        public void LPrime()
        {
            ...
            _faces[1].RotateSide(6, yellowSideBytes);
        ...
        public void F()
        {
            ...
            var redSideBytes = _faces[3].RotateSide(6, whiteSideBytes);
            var yellowSideBytes = _faces[5].RotateSide(4, redSideBytes);
            var orangeSideBytes = _faces[2].RotateSide(2, yellowSideBytes);
        ...
        public void FPrime()
        {
            ...
            var whiteSideBytes = _faces[0].RotateSide(4);
            var orangeSideBytes = _faces[2].RotateSide(2, whiteSideBytes);
            var yellowSideBytes = _faces[5].RotateSide(4, orangeSideBytes);
            var redSideBytes = _faces[3].RotateSide(6, yellowSideBytes);
        ...
        public void D()
        {
            ...
            var greenSideBytes = _faces[1].RotateSide(4);
            var redSideBytes = _faces[3].RotateSide(4, greenSideBytes);
            var blueSideBytes = _faces[4].RotateSide(4, redSideBytes);
            var orangeSideBytes = _faces[2].RotateSide(4, blueSideBytes);
            _faces[1].RotateSide(4, orangeSideBytes);
        ...
        public void DPrime()
        {
            ...
            var greenSideBytes = _faces[1].RotateSide(4);
            var orangeSideBytes = _faces[2].RotateSide(4, greenSideBytes);
            var blueSideBytes = _faces[4].RotateSide(4, orangeSideBytes);
            var redSideBytes = _faces[3].RotateSide(4, blueSideBytes);
            _faces[1].RotateSide(4, redSideBytes);
        ...
        public void B()
        {
            ...
            var orangeSideBytes = _faces[2].RotateSide(6, whiteSideBytes);
            var yellowSideBytes = _faces[5].RotateSide(0, orangeSideBytes);
            var redSideBytes = _faces[3].RotateSide(2, yellowSideBytes);
        ...
        public void BPrime()
        {
            ...
            var whiteSideBytes = _faces[0].RotateSide(0);
            var redSideBytes = _faces[3].RotateSide(2, whiteSideBytes);
            var yellowSideBytes = _faces[5].RotateSide(0, redSideBytes);
            var orangeSideBytes = _faces[2].RotateSide(6, yellowSideBytes);
